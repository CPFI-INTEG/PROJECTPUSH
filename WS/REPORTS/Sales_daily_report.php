...
/** Include PHPExcel */
  ...
  // SAVE TO AUDIT TRAIL
  $SqlAudit="insert into UserLogs(Description,Username,Name,Distributor) values('Successfully Download PUSH Excel file : ". gmdate('YMd').'.xlsx'." for  PUSH Product Report','PUSH','AUTO EMAIL','')";
...
$objPHPExcel->setActiveSheetIndex(0)
     ...
     ->setCellValue('A3', 'SALES DATE AS OF   : '.date("m/d/Y",strtotime("-1 day")))
  ...
  $sqlModal="select * from dbo.Vw_PUSHSALES where Dim3 not in ('WITHDRAWAL') AND TS BETWEEN '".date("m/d/Y",strtotime("-1 day"))."' AND '".date("m/d/Y",strtotime("-1 day"))."' ORDER BY DateAdded DESC";
...
$objPHPExcel->setActiveSheetIndex(1)
  ...
  $sqlModal="select * from dbo.Vw_PUSHSALES where Dim3 IN ('WITHDRAWAL') AND TS BETWEEN '".date("m/d/Y",strtotime("-1 day"))."' AND '".date("m/d/Y",strtotime("-1 day"))."' ORDER BY DateAdded Desc";
