...
<center>
    ...
    <form method="POST" action="authenticator_for_reports.php" id="login" name="frmLogin"  role="form" style="background-color:white;width:400px;height:350px;margin-top:20px;padding-bottom:50px">
      <div class="login-box">
  <div class="login-logo">
    ...
    <br>
    <b>--Signin to Download Excel Reports--</b><br><br>
