...
<?php
	...
	require_once("../../WS/Reports/helper.php");
	...
	$Handler= new libHandler();
		...
		if(!empty($Username) && !empty($password)){
			...
			if ($result) {
				...
				echo "<script>window.location.href='../Reports/sales.php'</script>";	
...
*/			} else {
					echo "<script>alert('Invalid Username or Password!');window.location.href='../Reports/index.php'</script>";
			}
		}else{
				echo "<script>alert('Invalid Username or Password!');window.location.href='../Reports/index.php'</script>";
		}
