	...
	$Handler= new libHandler();
		...
		if(!empty($Username) && !empty($password)){
			...
			if ($result) {
				...
				echo "<script>window.location.href='../WS/Reports/sales.php'</script>";	
...
*/			} else {
					echo "<script>alert('Invalid Username or Password!');window.location.href='../WS/Reports/index.php'</script>";
			}
		}else{
				echo "<script>alert('Invalid Username or Password!');window.location.href='../WS/Reports/index.php'</script>";
		}
